      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
            Choose your preferred measurement units for all features in Dog Log.
          </p>
        </div>
        {/* Coming Soon Card */}
          ...
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12 border border-gray-200/50 dark:border-gray-700/50">
            <div className="text-center">
              <div className="inline-flex items-center px-4 py-2 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 rounded-full text-sm font-medium mb-6">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20"><rect x="4" y="8" width="12" height="4" rx="2" /><rect x="8" y="4" width="4" height="12" rx="2" /></svg>
                Units System in Progress
              </div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">
                Measurement Preferences
              </h2>
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
                Soon you'll be able to select metric or imperial units for all measurements, including weight, distance, and temperature.
              </p>
              {/* Preview Features */}
              <div className="grid md:grid-cols-2 gap-6 mb-10">
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-2xl p-6 border border-green-200/50 dark:border-green-800/50">
                  <div className="w-12 h-12 bg-green-500/20 rounded-xl flex items-center justify-center mb-4 mx-auto">
                    <svg className="w-7 h-7 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect x="6" y="10" width="12" height="4" rx="2" /><rect x="10" y="6" width="4" height="12" rx="2" /></svg>
                  </div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Metric & Imperial</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">Switch between kg/lb, cm/in, and °C/°F</p>
                </div>
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-2xl p-6 border border-blue-200/50 dark:border-blue-800/50">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Default Preferences</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">Set your default units for all new entries</p>
                </div>
                <div className="bg-gradient-to-br from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20 rounded-2xl p-6 border border-yellow-200/50 dark:border-yellow-800/50">
                  ...
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Per-Dog Settings</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">Customize units for each of your dogs if needed</p>
                </div>
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-6 border border-purple-200/50 dark:border-purple-800/50">
                  <div className="w-12 h-12 bg-purple-500/20 rounded-xl flex items-center justify-center mb-4 mx-auto">
                    <svg className="w-7 h-7 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect x="6" y="6" width="12" height="12" rx="3" /></svg>
                  </div>
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Automatic Conversion</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">See values in your preferred units everywhere in the app</p>
                </div>
              </div>
              {/* Progress Indicator */}
              <div className="bg-gray-100 dark:bg-gray-700 rounded-full h-3 mb-4 overflow-hidden">
                <div className="bg-gradient-to-r from-green-400 to-blue-500 h-full rounded-full animate-pulse" style={{ width: '15%' }}></div>
              </div>
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">Development Progress: 15% Complete</p>
              {/* CTA Section */}
              <div className="space-y-4">
                <button disabled className="px-8 py-4 bg-gradient-to-r from-green-400 to-blue-500 text-white font-semibold rounded-2xl shadow-lg opacity-50 cursor-not-allowed transform hover:scale-105 transition-all duration-200">
                  ...
                  Units Preferences Coming Soon
                </button>
                <p className="text-xs text-gray-400 dark:text-gray-500">You'll be able to set your preferred units soon!</p>
              </div>
            </div>
          </div>
        </div>
