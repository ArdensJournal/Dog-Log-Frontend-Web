            ...
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
              ...
              <div className="mt-3 flex items-center gap-2">
                <input
                  ...
                  value={fcmToken}
                  readOnly
                  className="flex-1 px-3 py-2 bg-white dark:bg-gray-800 border border-green-300 dark:border-green-700 rounded text-xs text-gray-600 dark:text-gray-300"
                />
                <button
                  onClick={() => {
              ...
              <p className="text-xs text-green-700 dark:text-green-300 mt-2">
                Share this token with your backend developer to receive push notifications
              </p>
            </div>
          ) : (
