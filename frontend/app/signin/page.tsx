  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-100 via-white to-indigo-100 p-8">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-md">
        <h1 className="text-3xl font-bold text-indigo-700 mb-4 text-center">Sign In to Dog Log</h1>
        ...
        <p className="mt-4 text-center text-gray-600">
          ...
          <Link href="/signup" className="text-indigo-500 underline font-semibold">
            Sign Up
          </Link>
        </p>
      </div>
